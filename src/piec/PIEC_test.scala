    ...
    for (piecInputFilePath <- probEC_result_file_paths)
    {
        ...
        for (th <- 0.5 to 0.91 by 0.2)
        {
            ...
            if (dst == "orig")
            {
                ...
                val results_mt_01_p0 = evaluateResults(ground_truth_of_f("meeting(id0,id1)"), piec(map_of_f("meeting(id0,id1)"), thround, false))
                map_of_f("meeting(id0,id1)") = map_of_f("meeting(id0,id1)").map(x => x + thround)
                val results_mt_01_p1 = evaluateResults(ground_truth_of_f("meeting(id0,id1)"), piec(map_of_f("meeting(id0,id1)"), thround, true))
                ...
                val results_mt_12_p0 = evaluateResults(ground_truth_of_f("meeting(id1,id2)"), piec(map_of_f("meeting(id1,id2)"), thround, false))
                map_of_f("meeting(id1,id2)") = map_of_f("meeting(id1,id2)").map(x => x + thround)
                val results_mt_12_p1 = evaluateResults(ground_truth_of_f("meeting(id1,id2)"), piec(map_of_f("meeting(id1,id2)"), thround, true))
                ...
                val results_mt_13_p0 = evaluateResults(ground_truth_of_f("meeting(id1,id3)"), piec(map_of_f("meeting(id1,id3)"), thround, false))
                map_of_f("meeting(id1,id3)") = map_of_f("meeting(id1,id3)").map(x => x + thround)
                val results_mt_13_p1 = evaluateResults(ground_truth_of_f("meeting(id1,id3)"), piec(map_of_f("meeting(id1,id3)"), thround, true))
                ...
                val results_mt_45_p0 = evaluateResults(ground_truth_of_f("meeting(id4,id5)"), piec(map_of_f("meeting(id4,id5)"), thround, false))
                map_of_f("meeting(id4,id5)") = map_of_f("meeting(id4,id5)").map(x => x + thround)
                val results_mt_45_p1 = evaluateResults(ground_truth_of_f("meeting(id4,id5)"), piec(map_of_f("meeting(id4,id5)"), thround, true))
                ...
                val results_mt_26_p0 = evaluateResults(ground_truth_of_f("meeting(id2,id6)"), piec(map_of_f("meeting(id2,id6)"), thround, false))
                map_of_f("meeting(id2,id6)") = map_of_f("meeting(id2,id6)").map(x => x + thround)
                val results_mt_26_p1 = evaluateResults(ground_truth_of_f("meeting(id2,id6)"), piec(map_of_f("meeting(id2,id6)"), thround, true))
                ...
                val results_mt_10_p0 = evaluateResults(ground_truth_of_f("meeting(id1,id0)"), piec(map_of_f("meeting(id1,id0)"), thround, false))
                map_of_f("meeting(id1,id0)") = map_of_f("meeting(id1,id0)").map(x => x + thround)
                val results_mt_10_p1 = evaluateResults(ground_truth_of_f("meeting(id1,id0)"), piec(map_of_f("meeting(id1,id0)"), thround, true))
                ...
                val results_mt_21_p0 = evaluateResults(ground_truth_of_f("meeting(id2,id1)"), piec(map_of_f("meeting(id2,id1)"), thround, false))
                map_of_f("meeting(id2,id1)") = map_of_f("meeting(id2,id1)").map(x => x + thround)
                val results_mt_21_p1 = evaluateResults(ground_truth_of_f("meeting(id2,id1)"), piec(map_of_f("meeting(id2,id1)"), thround, true))
                ...
                val results_mt_31_p0 = evaluateResults(ground_truth_of_f("meeting(id3,id1)"), piec(map_of_f("meeting(id3,id1)"), thround, false))
                map_of_f("meeting(id3,id1)") = map_of_f("meeting(id3,id1)").map(x => x + thround)
                val results_mt_31_p1 = evaluateResults(ground_truth_of_f("meeting(id3,id1)"), piec(map_of_f("meeting(id3,id1)"), thround, true))
                ...
                val results_mt_54_p0 = evaluateResults(ground_truth_of_f("meeting(id5,id4)"), piec(map_of_f("meeting(id5,id4)"), thround, false))
                map_of_f("meeting(id5,id4)") = map_of_f("meeting(id5,id4)").map(x => x + thround)
                val results_mt_54_p1 = evaluateResults(ground_truth_of_f("meeting(id5,id4)"), piec(map_of_f("meeting(id5,id4)"), thround, true))
                ...
                val results_mt_62_p0 = evaluateResults(ground_truth_of_f("meeting(id6,id2)"), piec(map_of_f("meeting(id6,id2)"), thround, false))
                map_of_f("meeting(id6,id2)") = map_of_f("meeting(id6,id2)").map(x => x + thround)
                val results_mt_62_p1 = evaluateResults(ground_truth_of_f("meeting(id6,id2)"), piec(map_of_f("meeting(id6,id2)"), thround, true))
                ...
                val prout21_mt = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/meeting_${noiseAmount}-${dst}-t${thround}.meeting-precision.data")
                val recout21_mt = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/meeting_${noiseAmount}-${dst}-t${thround}.meeting-recall.data")
                val f1out21_mt = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/meeting_${noiseAmount}-${dst}-t${thround}.meeting-fmeasure.data")
                ...
                val prout22_mt = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/meeting_${noiseAmount}-${dst}-t${thround}.meeting-precision.data")
                val recout22_mt = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/meeting_${noiseAmount}-${dst}-t${thround}.meeting-recall.data")
                val f1out22_mt = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/meeting_${noiseAmount}-${dst}-t${thround}.meeting-fmeasure.data")
                ...
                val results_mv_01_p0 = evaluateResults(ground_truth_of_f("moving(id0,id1)"), piec(map_of_f("moving(id0,id1)"), thround, false))
                map_of_f("moving(id0,id1)") = map_of_f("moving(id0,id1)").map(x => x + thround)
                val results_mv_01_p1 = evaluateResults(ground_truth_of_f("moving(id0,id1)"), piec(map_of_f("moving(id0,id1)"), thround, true))
                ...
                val results_mv_02_p0 = evaluateResults(ground_truth_of_f("moving(id0,id2)"), piec(map_of_f("moving(id0,id2)"), thround, false))
                map_of_f("moving(id0,id2)") = map_of_f("moving(id0,id2)").map(x => x + thround)
                val results_mv_02_p1 = evaluateResults(ground_truth_of_f("moving(id0,id2)"), piec(map_of_f("moving(id0,id2)"), thround, true))
                ...
                val results_mv_03_p0 = evaluateResults(ground_truth_of_f("moving(id0,id3)"), piec(map_of_f("moving(id0,id3)"), thround, false))
                map_of_f("moving(id0,id3)") = map_of_f("moving(id0,id3)").map(x => x + thround)
                val results_mv_03_p1 = evaluateResults(ground_truth_of_f("moving(id0,id3)"), piec(map_of_f("moving(id0,id3)"), thround, true))
                ...
                val results_mv_12_p0 = evaluateResults(ground_truth_of_f("moving(id1,id2)"), piec(map_of_f("moving(id1,id2)"), thround, false))
                map_of_f("moving(id1,id2)") = map_of_f("moving(id1,id2)").map(x => x + thround)
                val results_mv_12_p1 = evaluateResults(ground_truth_of_f("moving(id1,id2)"), piec(map_of_f("moving(id1,id2)"), thround, true))
                ...
                val results_mv_13_p0 = evaluateResults(ground_truth_of_f("moving(id1,id3)"), piec(map_of_f("moving(id1,id3)"), thround, false))
                map_of_f("moving(id1,id3)") = map_of_f("moving(id1,id3)").map(x => x + thround)
                val results_mv_13_p1 = evaluateResults(ground_truth_of_f("moving(id1,id3)"), piec(map_of_f("moving(id1,id3)"), thround, true))
                ...
                val results_mv_23_p0 = evaluateResults(ground_truth_of_f("moving(id2,id3)"), piec(map_of_f("moving(id2,id3)"), thround, false))
                map_of_f("moving(id2,id3)") = map_of_f("moving(id2,id3)").map(x => x + thround)
                val results_mv_23_p1 = evaluateResults(ground_truth_of_f("moving(id2,id3)"), piec(map_of_f("moving(id2,id3)"), thround, true))
                ...
                val results_mv_34_p0 = evaluateResults(ground_truth_of_f("moving(id3,id4)"), piec(map_of_f("moving(id3,id4)"), thround, false))
                map_of_f("moving(id3,id4)") = map_of_f("moving(id3,id4)").map(x => x + thround)
                val results_mv_34_p1 = evaluateResults(ground_truth_of_f("moving(id3,id4)"), piec(map_of_f("moving(id3,id4)"), thround, true))
                ...
                val results_mv_45_p0 = evaluateResults(ground_truth_of_f("moving(id4,id5)"), piec(map_of_f("moving(id4,id5)"), thround, false))
                map_of_f("moving(id4,id5)") = map_of_f("moving(id4,id5)").map(x => x + thround)
                val results_mv_45_p1 = evaluateResults(ground_truth_of_f("moving(id4,id5)"), piec(map_of_f("moving(id4,id5)"), thround, true))
                ...
                val results_mv_56_p0 = evaluateResults(ground_truth_of_f("moving(id5,id6)"), piec(map_of_f("moving(id5,id6)"), thround, false))
                map_of_f("moving(id5,id6)") = map_of_f("moving(id5,id6)").map(x => x + thround)
                val results_mv_56_p1 = evaluateResults(ground_truth_of_f("moving(id5,id6)"), piec(map_of_f("moving(id5,id6)"), thround, true))
                ...
                val results_mv_10_p0 = evaluateResults(ground_truth_of_f("moving(id1,id0)"), piec(map_of_f("moving(id1,id0)"), thround, false))
                map_of_f("moving(id1,id0)") = map_of_f("moving(id1,id0)").map(x => x + thround)
                val results_mv_10_p1 = evaluateResults(ground_truth_of_f("moving(id1,id0)"), piec(map_of_f("moving(id1,id0)"), thround, true))
                ...
                val results_mv_20_p0 = evaluateResults(ground_truth_of_f("moving(id2,id0)"), piec(map_of_f("moving(id2,id0)"), thround, false))
                map_of_f("moving(id2,id0)") = map_of_f("moving(id2,id0)").map(x => x + thround)
                val results_mv_20_p1 = evaluateResults(ground_truth_of_f("moving(id2,id0)"), piec(map_of_f("moving(id2,id0)"), thround, true))
                ...
                val results_mv_30_p0 = evaluateResults(ground_truth_of_f("moving(id3,id0)"), piec(map_of_f("moving(id3,id0)"), thround, false))
                map_of_f("moving(id3,id0)") = map_of_f("moving(id3,id0)").map(x => x + thround)
                val results_mv_30_p1 = evaluateResults(ground_truth_of_f("moving(id3,id0)"), piec(map_of_f("moving(id3,id0)"), thround, true))
                ...
                val results_mv_21_p0 = evaluateResults(ground_truth_of_f("moving(id2,id1)"), piec(map_of_f("moving(id2,id1)"), thround, false))
                map_of_f("moving(id2,id1)") = map_of_f("moving(id2,id1)").map(x => x + thround)
                val results_mv_21_p1 = evaluateResults(ground_truth_of_f("moving(id2,id1)"), piec(map_of_f("moving(id2,id1)"), thround, true))
                ...
                val results_mv_31_p0 = evaluateResults(ground_truth_of_f("moving(id3,id1)"), piec(map_of_f("moving(id3,id1)"), thround, false))
                map_of_f("moving(id3,id1)") = map_of_f("moving(id3,id1)").map(x => x + thround)
                val results_mv_31_p1 = evaluateResults(ground_truth_of_f("moving(id3,id1)"), piec(map_of_f("moving(id3,id1)"), thround, true))
                ...
                val results_mv_32_p0 = evaluateResults(ground_truth_of_f("moving(id3,id2)"), piec(map_of_f("moving(id3,id2)"), thround, false))
                map_of_f("moving(id3,id2)") = map_of_f("moving(id3,id2)").map(x => x + thround)
                val results_mv_32_p1 = evaluateResults(ground_truth_of_f("moving(id3,id2)"), piec(map_of_f("moving(id3,id2)"), thround, true))
                ...
                val results_mv_43_p0 = evaluateResults(ground_truth_of_f("moving(id4,id3)"), piec(map_of_f("moving(id4,id3)"), thround, false))
                map_of_f("moving(id4,id3)") = map_of_f("moving(id4,id3)").map(x => x + thround)
                val results_mv_43_p1 = evaluateResults(ground_truth_of_f("moving(id4,id3)"), piec(map_of_f("moving(id4,id3)"), thround, true))
                ...
                val results_mv_54_p0 = evaluateResults(ground_truth_of_f("moving(id5,id4)"), piec(map_of_f("moving(id5,id4)"), thround, false))
                map_of_f("moving(id5,id4)") = map_of_f("moving(id5,id4)").map(x => x + thround)
                val results_mv_54_p1 = evaluateResults(ground_truth_of_f("moving(id5,id4)"), piec(map_of_f("moving(id5,id4)"), thround, true))
                ...
                val results_mv_65_p0 = evaluateResults(ground_truth_of_f("moving(id6,id5)"), piec(map_of_f("moving(id6,id5)"), thround, false))
                map_of_f("moving(id6,id5)") = map_of_f("moving(id6,id5)").map(x => x + thround)
                val results_mv_65_p1 = evaluateResults(ground_truth_of_f("moving(id6,id5)"), piec(map_of_f("moving(id6,id5)"), thround, true))
                ...
                val prout21_mv = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/moving_${noiseAmount}-${dst}-t${thround}.moving-precision.data")
                val recout21_mv = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/moving_${noiseAmount}-${dst}-t${thround}.moving-recall.data")
                val f1out21_mv = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/moving_${noiseAmount}-${dst}-t${thround}.moving-fmeasure.data")
                ...
                val prout22_mv = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/moving_${noiseAmount}-${dst}-t${thround}.moving-precision.data")
                val recout22_mv = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/moving_${noiseAmount}-${dst}-t${thround}.moving-recall.data")
                val f1out22_mv = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/moving_${noiseAmount}-${dst}-t${thround}.moving-fmeasure.data")
            ...
            if (dst == "enh")
            {
                ...
                val results_f_12_p0 = evaluateResults(ground_truth_of_f("fighting(id1,id2)"), piec(map_of_f("fighting(id1,id2)"), thround, false))
                map_of_f("fighting(id1,id2)") = map_of_f("fighting(id1,id2)").map(x => x + thround)
                val results_f_12_p1 = evaluateResults(ground_truth_of_f("fighting(id1,id2)"), piec(map_of_f("fighting(id1,id2)"), thround, true))
                ...
                val results_f_21_p0 = evaluateResults(ground_truth_of_f("fighting(id2,id1)"), piec(map_of_f("fighting(id2,id1)"), thround, false))
                map_of_f("fighting(id2,id1)") = map_of_f("fighting(id2,id1)").map(x => x + thround)
                val results_f_21_p1 = evaluateResults(ground_truth_of_f("fighting(id2,id1)"), piec(map_of_f("fighting(id2,id1)"), thround, true))
                ...
                val results_f_26_p0 = evaluateResults(ground_truth_of_f("fighting(id2,id6)"), piec(map_of_f("fighting(id2,id6)"), thround, false))
                map_of_f("fighting(id2,id6)") = map_of_f("fighting(id2,id6)").map(x => x + thround)
                val results_f_26_p1 = evaluateResults(ground_truth_of_f("fighting(id2,id6)"), piec(map_of_f("fighting(id2,id6)"), thround, true))
                ...
                val results_f_62_p0 = evaluateResults(ground_truth_of_f("fighting(id6,id2)"), piec(map_of_f("fighting(id6,id2)"), thround, false))
                map_of_f("fighting(id6,id2)") = map_of_f("fighting(id6,id2)").map(x => x + thround)
                val results_f_62_p1 = evaluateResults(ground_truth_of_f("fighting(id6,id2)"), piec(map_of_f("fighting(id6,id2)"), thround, true))
                ...
                val results_f_34_p0 = evaluateResults(ground_truth_of_f("fighting(id3,id4)"), piec(map_of_f("fighting(id3,id4)"), thround, false))
                map_of_f("fighting(id3,id4)") = map_of_f("fighting(id3,id4)").map(x => x + thround)
                val results_f_34_p1 = evaluateResults(ground_truth_of_f("fighting(id3,id4)"), piec(map_of_f("fighting(id3,id4)"), thround, true))
                ...
                val results_f_43_p0 = evaluateResults(ground_truth_of_f("fighting(id4,id3)"), piec(map_of_f("fighting(id4,id3)"), thround, false))
                map_of_f("fighting(id4,id3)") = map_of_f("fighting(id4,id3)").map(x => x + thround)
                val results_f_43_p1 = evaluateResults(ground_truth_of_f("fighting(id4,id3)"), piec(map_of_f("fighting(id4,id3)"), thround, true))
                ...
                val results_f_45_p0 = evaluateResults(ground_truth_of_f("fighting(id4,id5)"), piec(map_of_f("fighting(id4,id5)"), thround, false))
                map_of_f("fighting(id4,id5)") = map_of_f("fighting(id4,id5)").map(x => x + thround)
                val results_f_45_p1 = evaluateResults(ground_truth_of_f("fighting(id4,id5)"), piec(map_of_f("fighting(id4,id5)"), thround, true))
                ...
                val results_f_54_p0 = evaluateResults(ground_truth_of_f("fighting(id5,id4)"), piec(map_of_f("fighting(id5,id4)"), thround, false))
                map_of_f("fighting(id5,id4)") = map_of_f("fighting(id5,id4)").map(x => x + thround)
                val results_f_54_p1 = evaluateResults(ground_truth_of_f("fighting(id5,id4)"), piec(map_of_f("fighting(id5,id4)"), thround, true))
                ...
                val results_f_67_p0 = evaluateResults(ground_truth_of_f("fighting(id6,id7)"), piec(map_of_f("fighting(id6,id7)"), thround, false))
                map_of_f("fighting(id6,id7)") = map_of_f("fighting(id6,id7)").map(x => x + thround)
                val results_f_67_p1 = evaluateResults(ground_truth_of_f("fighting(id6,id7)"), piec(map_of_f("fighting(id6,id7)"), thround, true))
                ...
                val results_f_76_p0 = evaluateResults(ground_truth_of_f("fighting(id7,id6)"), piec(map_of_f("fighting(id7,id6)"), thround, false))
                map_of_f("fighting(id7,id6)") = map_of_f("fighting(id7,id6)").map(x => x + thround)
                val results_f_76_p1 = evaluateResults(ground_truth_of_f("fighting(id7,id6)"), piec(map_of_f("fighting(id7,id6)"), thround, true))
                ...
                val prout21_f = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/fighting_${noiseAmount}-${dst}-t${thround}.fighting-precision.data")
                val recout21_f = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/fighting_${noiseAmount}-${dst}-t${thround}.fighting-recall.data")
                val f1out21_f = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC1/$noiseAmount/fighting_${noiseAmount}-${dst}-t${thround}.fighting-fmeasure.data")
                ...
                val prout22_f = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/fighting_${noiseAmount}-${dst}-t${thround}.fighting-precision.data")
                val recout22_f = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/fighting_${noiseAmount}-${dst}-t${thround}.fighting-recall.data")
                val f1out22_f = new File(s"/home/cgvlas/Demokritos/TPLP-toy/statistics/PIEC2/$noiseAmount/fighting_${noiseAmount}-${dst}-t${thround}.fighting-fmeasure.data")
